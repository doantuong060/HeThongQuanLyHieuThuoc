...
namespace DuAnCuoiKy_QuanLyHieuThuoc.Controllers
{
    public class HoaDonsController : Controller
    {
        ...
        {
            var hieuThuocDbContext = _context.HoaDons.Include(h => h.MaNvNavigation);
        ...
        public async Task<IActionResult> Create([Bind("MaHd,NgayBan,MaNv,TongTien,GhiChu")] HoaDon hoaDon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaHd,NgayBan,MaNv,TongTien,GhiChu")] HoaDon hoaDon)
        {
            if (id != hoaDon.MaHd)
            {
                return NotFound();
