...
namespace DuAnCuoiKy_QuanLyHieuThuoc.Controllers
{
    public class PhieuNhapsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaPhieuNhap,NgayNhap,MaNcc,MaNv,GhiChu,TongTien")] PhieuNhap phieuNhap)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("MaPhieuNhap,NgayNhap,MaNcc,MaNv,GhiChu,TongTien")] PhieuNhap phieuNhap)
        {
