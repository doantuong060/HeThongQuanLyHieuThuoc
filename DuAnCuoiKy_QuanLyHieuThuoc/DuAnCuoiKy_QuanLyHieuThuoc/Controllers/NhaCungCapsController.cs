...
namespace DuAnCuoiKy_QuanLyHieuThuoc.Controllers
{
    public class NhaCungCapsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaNcc,TenNcc,DiaChi,TinhThanh,SoDienThoai,Email,TrangThai")] NhaCungCap nhaCungCap)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaNcc,TenNcc,DiaChi,TinhThanh,SoDienThoai,Email,TrangThai")] NhaCungCap nhaCungCap)
        {
